...
namespace RecursosHumanos.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Codigo_Departamento,Nombre")] Departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Codigo_Departamento,Nombre")] Departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
